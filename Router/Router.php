...
//##################//
    class router {
        /*//Variables//~·~·~·~·~·~·~·~############*/
            ...
            static $_instance;
        /*~·~·~·~·~·~·~·~·~·~·~·~·~·~·~·~·~·~·~·~·~·~·~·~·~·~·~·~·~·~·~·~·~·~·~*/
            public static function getInstance() { //Constructor en el caso de que no exista
        ...
        /*~·~·~·~·~·~·~·~·~·~·~·~·~·~·~·~·~·~·~·~·~·~·~·~·~·~·~·~·~·~·~·~·~·~·~*/
            function __construct() {//Esta Funcion esta Virgen   
        ...
        /*~·~·~·~·~·~·~·~·~·~·~·~·~·~·~·~·~·~·~·~·~·~·~·~·~·~·~·~·~·~·~·~·~·~·~*/
            private function loadModule() {
                ...
                $path = 'Module/Contact/Controller/ControllerContact.class.php';
                require_once($path);

                $controllerName = 'ControllerContact';
                return new $controllerName;
